...
class Data25ForecastGet200Response(BaseModel):
    """
    Data25ForecastGet200Response
    """ # noqa: E501
    list: Optional[List[Data25ForecastGet200ResponseListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [Data25ForecastGet200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
