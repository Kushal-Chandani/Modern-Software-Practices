...
class Data25WeatherGet200ResponseMain(BaseModel):
    """
    ...
    humidity: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["temp", "feels_like", "humidity"]
