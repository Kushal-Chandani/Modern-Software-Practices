...
class Data25AirPollutionGet200Response(BaseModel):
    """
    Data25AirPollutionGet200Response
    """ # noqa: E501
    list: Optional[List[Data25AirPollutionGet200ResponseListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [Data25AirPollutionGet200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
